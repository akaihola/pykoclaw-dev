...
- [x] Link every current workspace package from `/home/agent/pykoclaw/README.md`
- [x] Audit root and core READMEs against current plugin entry points and commands
- [x] Fix stale package/plugin counts in `/home/agent/pykoclaw/CLAUDE.md`
- [x] Add dedicated READMEs for `/home/agent/pykoclaw/pykoclaw-slack`, `/home/agent/pykoclaw/pykoclaw-messaging`, and `/home/agent/pykoclaw/pykoclaw-vision`
