...
| claude-sdk      | [acp-protocol-fix.md], [acp-debugging.md], [sdk-schema-gotcha.md], [result-message-fallback.md], [claude-sdk-setting-sources.md]                                                                                                              |
...
| gotcha          | [neonize-quirks.md], [sqlite-migration-gotcha.md], [asyncio-shutdown-gotcha.md], [tool-use-text-concatenation.md], [matrix-nio-gotchas.md], [plugin-config-env-file.md], [unmerged-feature-branch-gotcha.md], [claude-sdk-setting-sources.md] |
