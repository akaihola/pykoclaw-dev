...
| [memory-canonical-vs-harness-logs.md] | memory, architecture, plugins, harness, mnesis                                           | Durable memory must be Pykoclaw-owned and normalized; harness logs are only for bootstrap/audit                                                      |
...
| [unmerged-feature-branch-gotcha.md]   | git, worktree, gotcha, dev-workflow                                                      | Feature committed to branch but never merged into main — silently missing at runtime                                                                 |
| [claude-sdk-stderr-silence.md]        | claude-sdk, debugging, gotcha, logging                                                   | SDK stderr discarded by default; fix + where claude writes its own debug logs                                                                        |
...
| gotcha                 | [neonize-quirks.md], [sqlite-migration-gotcha.md], [asyncio-shutdown-gotcha.md], [tool-use-text-concatenation.md], [matrix-nio-gotchas.md], [plugin-config-env-file.md], [unmerged-feature-branch-gotcha.md], [claude-sdk-setting-sources.md], [claude-sdk-stream-event.md] |
| messaging              | [channel-dispatch.md]                                                                                                                                                                                                                                                       |
| mitto                  | [mitto-setup.md], [acp-protocol-fix.md], [acp-debugging.md], [asyncio-shutdown-gotcha.md], [tool-use-text-concatenation.md], [testi-venv-isolation.md]                                                                                                                      |
| zombie                 | [asyncio-shutdown-gotcha.md]                                                                                                                                                                                                                                                |
| mobile                 | [mitto-setup.md]                                                                                                                                                                                                                                                            |
| neonize                | [neonize-quirks.md]                                                                                                                                                                                                                                                         |
| plugins                | [plugin-system.md], [memory-canonical-vs-harness-logs.md]                                                                                                                                                                                                                   |
...
| streaming              | [claude-sdk-stream-event.md]                                                                                                                                                                                                                                                |
| testi                  | [testi-venv-isolation.md]                                                                                                                                                                                                                                                   |
| isolation              | [testi-venv-isolation.md]                                                                                                                                                                                                                                                   |
| deployment             | [testi-venv-isolation.md]                                                                                                                                                                                                                                                   |
...
| slackify-markdown      | [slack-plugin-gotchas.md]                                                                                                                                                                                                                                                   |
| thread-scoped-sessions | [slack-plugin-gotchas.md]                                                                                                                                                                                                                                                   |
| slack                  | [slack-plugin-gotchas.md], [slack-reply-extraction.md], [agent-output-duplication.md]                                                                                                                                                                                       |
...
| session-resume | [matrix-agent-reply-storage.md], [session-resume-retry.md] |
...
[unmerged-feature-branch-gotcha.md]: unmerged-feature-branch-gotcha.md
